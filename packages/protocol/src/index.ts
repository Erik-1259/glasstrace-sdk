...
export {
  ...
  type ResultEvidenceCapabilities,
...
// --- Result-evidence protocol (wire version 1) ---
export {
  ...
  type ResultEvidenceRowScalarKeyParseFailureReason,
  type ResultEvidenceRowScalarKeyParseResult,
  ...
  type ResultEvidenceRowMetadataKeyParseFailureReason,
  type ResultEvidenceRowMetadataKeyParseResult,
  isResultEvidenceTimestampShapedNumeric,
  validateResultEvidenceCompleteFamily,
  type ResultEvidenceCompleteFamilyValidationFailureReason,
  type ResultEvidenceCompleteFamilyValidationResult,
