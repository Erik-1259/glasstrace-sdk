...
- 01f846d: Add the provider-neutral result-evidence protocol (wire version 1): closed
...
- 3fac2b1: Split `unsupported_key` into two more specific side-effect omission
...
- 53d7ddd: Add the optional `decisionTrace` option and `GLASSTRACE_DECISION_TRACE` env var
...
- 76c447a: Add the value-fidelity scalar contract for side-effect evidence.
