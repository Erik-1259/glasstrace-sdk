...
| `MAX_PENDING_SPANS` | `packages/sdk/src/enriching-exporter.ts:31` | `../glasstrace-product/docs/component-designs/sdk-architecture.md` §5.4 Buffering during KEY_PENDING | |
...
| `WELL_KNOWN_GLASSTRACE_PATH` | `packages/sdk/src/cli/discovery-file.ts:23` | RFC 8615 (https://www.rfc-editor.org/rfc/rfc8615) + `../glasstrace-product/docs/component-designs/sdk-architecture.md` §7.1 Static discovery file | |
...
Two Tier-1 surfaces named in sdk-architecture.md §8.2 are **deferred** and not
yet in the table:
